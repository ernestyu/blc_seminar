...
static constexpr int64_t STALE_CHECK_INTERVAL = 10 * 60 * 6 * 24 * 365; // 1 year. Used to be 10 minutes but we want to allow to use a blockchain that is not actively mined
...
static constexpr int STALE_RELAY_AGE_LIMIT = 30 * 24 * 60 * 60 * 12; // Set to one year so that we can not mine for a lot of time
