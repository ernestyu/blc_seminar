...
static RPCHelpMan addconnection()
{
    return RPCHelpMan{"addconnection",
        ...
        RPCExamples{
        HelpExampleCli("addconnection", "\"192.168.0.6:8555\" \"outbound-full-relay\"")
            + HelpExampleRpc("addconnection", "\"192.168.0.6:8555\" \"outbound-full-relay\"")
        },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
...
static RPCHelpMan addpeeraddress()
{
    return RPCHelpMan{"addpeeraddress",
        ...
        RPCExamples{
        HelpExampleCli("addpeeraddress", "\"1.2.3.4\" 8555")
    + HelpExampleRpc("addpeeraddress", "\"1.2.3.4\", 8555")
        },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    NodeContext& node = EnsureAnyNodeContext(request.context);
