...
Add these lines to your `/etc/tor/torrc` (or equivalent config file):
    ...
    HiddenServicePort 8555 127.0.0.1:8334

The directory can be different of course, but virtual port numbers should be equal to
your bitcoind's P2P listen port (8555 by default), and target addresses and ports
...
and open port 8555 on your firewall (or use port mapping, i.e., `-upnp` or `-natpmp`).
